...
//test
var meetings = fs.readFileSync('/home/ec2-user/environment/data-structures/Week02/m09addressescorrected.json');
...
async.eachSeries(addresses, function(value, callback) {
    ...
    // fs.writeFileSync('/home/ec2-user/environment/data-structures/Week03/geoaddressesm09test.json', JSON.stringify(meetingsData));
    console.log('*** *** *** *** ***');
